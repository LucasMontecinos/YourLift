...
SRV=$!; sleep 2
cd pruebas || exit 1
for t in t_meet.js t_cruce2.js t_extra.js t_ct.js t_rec.js t_next3.js t_extra_col.js t_sync.js t_sync2.js t_bug.js t_gl.js t_ordenextra.js t_crono.js t_hojaequipo.js t_peers.js t_foco.js t_lote.js t_pdf.js; do
  echo "════════ $t"
